...
export class DoraMp4 extends SourceBase {
    constructor() {
      ...
      this.host = atob("aHR0cHM6Ly9kb3JhbWFzbXA0LmlvLw==");
      this.api = atob("aHR0cHM6Ly91c2VyYXBpLmNsb3VkZmxlaXIueHl6L2dyYXBocWw");
      ...
      try{
        ...
        try{
          ...
          const dora = JSON.parse(await window.fPost(this.api, 
            {"content-type": "application/json"},
            {"RAW_GEAN": {"operationName":"PaginationDorama","variables":{"page":1,"limit":24,"filter":{"isTVShow":false}},"extensions":{"clientLibrary":{"name":"@apollo/client","version":"4.0.7"}},"query":"query PaginationDorama($sort: SortDorama, $limit: Int, $filter: FilterDoramasInput, $page: Int, $excludedLabelSlugs: [String!]) {\n  paginationDorama(\n    sort: $sort\n    limit: $limit\n    filter: $filter\n    page: $page\n    excludedLabelSlugs: $excludedLabelSlugs\n  ) {\n    count\n    pageInfo {\n      currentPage\n      perPage\n      pageCount\n      itemCount\n      hasNextPage\n      hasPreviousPage\n      __typename\n    }\n    items {\n      _id\n      name\n      name_es\n      slug\n      isTVShow\n      isFinish\n      premiere\n      first_air_date\n      number_of_episodes\n      number_of_episodes_online\n      poster_path\n      poster\n      backdrop_path\n      backdrop\n      subtitles_available\n      seasons {\n        season_number\n        emision\n        number_of_episodes\n        number_of_episodes_online\n        uploading\n        pause\n        commingSoon\n        status\n        status_source\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}"}
          }));
        ...
        try{
          const movi = JSON.parse(await window.fPost(this.api, 
            {"content-type": "application/json"},
            {"RAW_GEAN": {"operationName":"PaginationMovie","variables":{"page":1,"limit":24,"filter":{}},"extensions":{"clientLibrary":{"name":"@apollo/client","version":"4.0.7"}},"query":"query PaginationMovie($sort: SortMovie, $limit: Int, $filter: FilterMoviesInput, $page: Int, $excludedLabelSlugs: [String!]) {\n  paginationMovie(\n    sort: $sort\n    limit: $limit\n    filter: $filter\n    page: $page\n    excludedLabelSlugs: $excludedLabelSlugs\n  ) {\n    count\n    pageInfo {\n      currentPage\n      perPage\n      pageCount\n      itemCount\n      hasNextPage\n      hasPreviousPage\n      __typename\n    }\n    items {\n      _id\n      slug\n      name\n      name_es\n      poster_path\n      release_date\n      commingSoon\n      status\n      status_source\n      status_changed_at\n      poster\n      backdrop_path\n      backdrop\n      subtitles_available\n      __typename\n    }\n    __typename\n  }\n}"}
          }));
