export class MailRu {
    ...
    async getDDL(after, onError, web){
            let basics =  await fGet(web, {"Cookie":"", "Referer": web}, true);
            ...
            Object.keys(data.headers).forEach((key)=>{
                ...
                if(data.headers[key].indexOf("video_key") != -1){
                    ...
                    headers["Cookie"] = data.headers[key]
                }
            })
            let outdata = {};
            headers["Referer"]= "https://my1.imgsmail.ru/r/video2/uvpv3.swf?75&Cookie=" + cookie;
