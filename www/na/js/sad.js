...
function loadSettings() {
    let settings = {
      ...
      selected_player:  {type: "multi", currentValue: "html", title: "Reproducto de video preferido", values:  {"html": "html", "Integrado (solo android)": "internal", "Externo (solo android)": "external"}} // "videoJs": "videojs", "Plyr player": "plyr",
    };
